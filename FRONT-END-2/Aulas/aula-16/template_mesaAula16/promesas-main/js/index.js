...
function renderizarDadosUsuario(dados) {
    ...
    // inserir foto na tela html para o usuario
    let foto = document.createElement("img");
    foto.src = dados.imagem.media;
    foto.className = "foto";
    document.body.appendChild(foto);

    // inserir nome completo do usuario na tela html
    let nome = document.createElement("h1");
    nome.innerHTML = dados.nome.primeiro + " " + dados.nome.utlimo;
    document.body.appendChild(nome);

    // inserir email do usuario na tela html
    let email = document.createElement("p");
    email.innerHTML = dados.email;
    document.body.appendChild(email);

    tarjeta.appendChild(foto);
    tarjeta.appendChild(nome);
